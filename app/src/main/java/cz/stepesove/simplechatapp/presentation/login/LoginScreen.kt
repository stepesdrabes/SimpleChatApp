    ...
    Scaffold(
        ...
        Box(modifier = Modifier.padding(it)) {
            LazyColumn(
                ...
                item { TitleBox(title = stringResource(id = R.string.login_title)) }
                ...
                item {
                    Column(
                        ...
                        IconLabelTextField(
                            ...
                            label = stringResource(id = R.string.login_input_username_label)
                        ) { newText ->
                            viewModel.onEvent(LoginUiEvent.LoginUsernameChanged(newText.text))
                        }

                        IconLabelTextField(
                            iconId = R.drawable.ic_fi_rr_password,
                            label = stringResource(id = R.string.login_input_password_label),
                            isPassword = true
                        ) { newText ->
                            viewModel.onEvent(LoginUiEvent.LoginPasswordChanged(newText.text))
                        }
                    }
                }
                ...
                item {
                    IconLabelButton(
                        label = stringResource(id = R.string.login_login_button_label),
